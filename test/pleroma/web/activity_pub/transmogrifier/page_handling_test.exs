  ...
  test "Lemmy Page" do
    Tesla.Mock.mock(fn
      %{url: "https://enterprise.lemmy.ml/post/3"} ->
        %Tesla.Env{status: 200, body: File.read!("test/fixtures/tesla_mock/lemmy-page.json")}

      %{url: "https://enterprise.lemmy.ml/u/nutomic"} ->
        %Tesla.Env{status: 200, body: File.read!("test/fixtures/tesla_mock/lemmy-user.json")}
    end)
